...
?>   
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">Tiger Kicking Form <small>Second Move</small></h1>
          <ol class="breadcrumb">
			...
			<li><a href="Earth-DragonForm.php">Tiger Form</a></li>
			 <li><a href="Tiger-KickingSubforms1-4.php">Tiger Kicking form Moves</a></li>
			<li class="active">First Move</li>
          </ol>
        </div>
...
<param name="movie" value="FirstMoveFastCrop.swf"/>
<param name="menu" value="true"/>
<param name="quality" value="high"/>
<param name="bgcolor" value="#FFFFFF"/>
<noscript><a rel="nofollow" href ="http://www.java.com">Install or enable JAVA</a></noscript>
<embed src="FirstMoveFastCrop.swf" menu="true" quality="high" bgcolor="#FFFFFF" width="480" height="360" name="player" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"/>
</object> 
        </div>
