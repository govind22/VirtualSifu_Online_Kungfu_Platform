      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Second Move</li>
          </ol>
        </div>
...
<param name="movie" value="SecondMovCrop.swf"/>
<param name="menu" value="true"/>
<param name="quality" value="high"/>
<param name="bgcolor" value="#FFFFFF"/>
<noscript><a rel="nofollow" href ="http://www.java.com">Install or enable JAVA</a></noscript>
<embed src="SecondMovCrop.swf" menu="true" quality="high" bgcolor="#FFFFFF" width="480" height="360" name="player" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"/>
</object> 
        </div>
