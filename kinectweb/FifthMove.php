...
?>   
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">Tiger Kicking Form <small>Fifth Move</small></h1>
          <ol class="breadcrumb">
...
<param name="movie" value="FifthForm.swf"/>
<param name="menu" value="true"/>
<param name="quality" value="high"/>
<param name="bgcolor" value="#FFFFFF"/>
<noscript><a rel="nofollow" href ="http://www.java.com">Install or enable JAVA</a></noscript>
<embed src="FifthForm.swf" menu="true" quality="high" bgcolor="#FFFFFF" width="480" height="360" name="player" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"/>
</object> 
      </div>
